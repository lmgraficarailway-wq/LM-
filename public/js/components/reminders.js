                ...
                <div class="rm-field" style="margin-top:0.25rem;">
                    <label for="menu-inp-discount-close" style="display:flex; align-items:flex-start; gap:0.75rem; cursor:pointer; user-select:none;">
                        ...
                        <div>
                            ...
                            <small style="display:block; color:#6b7280; font-size:0.78rem; margin-top:2px;">Marque se o valor deste card�pio deve ser descontado no fechamento do evento. A informa��o aparecer� no financeiro.</small>
                        </div>
                    </label>
                </div>
